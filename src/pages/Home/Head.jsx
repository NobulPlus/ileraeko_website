            ...
            <div className='grid grid-cols-2 mt-[40px] pb-[5px]'>
                <div>
                    ...
                    <div className='mt-[50px] flex gap-[20px]'>
                        <button className='bg-[#f28201] py-[10px] px-[20px] text-white text-[16px] font-semibold tracking-[0.4px] cursor-pointer rounded-[7px] hover:bg-[#e06f00] transition duration-300'>View Plans</button>
                        <button className='bg-white py-[10px] px-[20px] text-[#f28201] text-[16px] font-semibold tracking-[0.4px] cursor-pointer rounded-[7px] border border-[#f28201] hover:bg-[#fde4be] transition duration-300'>Get Started</button>
                    </div>
                </div>
