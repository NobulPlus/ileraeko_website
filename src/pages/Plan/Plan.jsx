    ...
    <>
      ...
      <div id='plans' className='container px-4 py-12 mx-auto'>
        <div className='grid gap-8 md:grid-cols-3'>
          <div className='p-6 rounded-lg shadow-md bg-blend-luminosity'>
              <div className='title'>
            ...
            <div className='items-center justify-between foot'>
              ...
              <div className='flex items-center justify-center pt-12 space-x-4 foot-button'>
                <button className='px-4 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700'>
                  <Link to='https://selfregistration.lshsportal.com:467/'>Buy Now</Link>
                </button>
                <a href={standard} target='_blank' rel='noopener noreferrer' className='px-4 py-2 text-blue-600 border border-blue-600 rounded-md hover:bg-blue-100'>
                  View Plan
                </a>
              </div>
            </div>
          ...
          <div className='p-6 bg-green-100 rounded-lg shadow-md'>
            ...
            <div className='items-center justify-between foot'>
              ...
              <div className='flex items-center justify-center pt-12 space-x-4 foot-button'>
                ...
                <a href={standard} target='_blank' rel='noopener noreferrer' className='px-4 py-2 text-green-600 border border-green-600 rounded-md hover:bg-green-100'>
                  View Plan
                </a>
              </div>
            </div>
          ...
          <div className='p-6 bg-red-100 rounded-lg shadow-md'>
            ...
            <div className='items-center justify-between foot'>
              ...
              <div className='flex items-center justify-center pt-4 space-x-4 foot-button'>
                ...
                <a href={plusPlan} target='_blank' rel='noopener noreferrer' className='px-4 py-2 text-red-600 border border-red-600 rounded-md hover:bg-red-100'>
                  View Plan
                </a>
              </div>
            </div>
          ...
          <div className='p-6 bg-yellow-100 rounded-lg shadow-md'>
            ...
            <div className='items-center justify-between foot'>
              ...
              <div className='flex items-center justify-center pt-8 space-x-4 foot-button'>
                ...
                <a href={plusPlan} target='_blank' rel='noopener noreferrer' className='px-4 py-2 text-yellow-600 border border-yellow-600 rounded-md hover:bg-yellow-100'>
                  View Plan
                </a>
              </div>
            </div>
          ...
          <div className='p-6 bg-purple-100 rounded-lg shadow-md'>
            ...
            <div className='items-center justify-between foot'>
              ...
              <div className='flex items-center justify-center pt-8 space-x-4 foot-button'>
                ...
                <a href={seniorsPlan} target='_blank' rel='noopener noreferrer' className='px-4 py-2 text-purple-600 border border-purple-600 rounded-md hover:bg-purple-100'>
                  View Plan
                </a>
              </div>
            </div>
          ...
          <div className='p-6 bg-teal-100 rounded-lg shadow-md'>
            ...
            <div className='items-center justify-between foot'>
              ...
              <div className='flex items-center justify-center pt-8 space-x-4 foot-button'>
                ...
                <a href={seniorsPlan} target='_blank' rel='noopener noreferrer' className='px-4 py-2 text-teal-600 border border-teal-600 rounded-md hover:bg-teal-100'>
                  View Plan
                </a>
              </div>
            </div>
          ...
          <div className='p-6 rounded-lg shadow-md bg-lime-100'>
            ...
            <div className='items-center justify-between foot'>
              ...
              <div className='flex items-center justify-center pt-12 space-x-4 foot-button'>
                ...
                <a href={telemedicine} target='_blank' rel='noopener noreferrer' className='px-4 py-2 border rounded-md border-lime-600 text-lime-600 hover:bg-purple-100'>
                  View Plan
                </a>
              </div>
            </div>
          ...
          <div className='p-6 bg-orange-100 rounded-lg shadow-md'>
            ...
            <div className='items-center justify-between foot'>
              ...
              <div className='flex items-center justify-center pt-4 space-x-4 foot-button'>
                ...
                <a href={diaspora} target='_blank' rel='noopener noreferrer' className='px-4 py-2 text-orange-600 border border-orange-600 rounded-md hover:bg-orange-100'>
                  View Plan
                </a>
              </div>
            </div>
