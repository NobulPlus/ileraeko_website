    ...
    <div className="container px-4 pt-24 pb-8 mx-auto">
      <div className="grid items-center grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <div className="space-y-6">
          <h3 className="text-2xl font-semibold text-gray-800 md:text-3xl">Advanced Pharmacy Benefits</h3>
          ...
          <p>
            <Link to="/plan" className="inline-flex items-center text-lg font-semibold text-orange-600">
