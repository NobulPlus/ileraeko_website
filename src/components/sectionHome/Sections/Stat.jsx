          ...
          <div className="max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-md">
            <div className="p-6 md:p-8">
              ...
              <p className="mb-8 leading-relaxed text-gray-600">
                We have over 390 and still counting Health Care Providers and Over  1.13 million lives as at the end of <b>August</b> 2024 registered on the scheme with numbers continuing to grow.
              </p>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div className="p-6 text-center bg-gray-100 rounded-lg md:p-8">
                  <div className="mb-2 text-4xl font-bold text-gray-800 md:text-5xl">
                    {counterState && <CountUp start={0} end={1130061} duration={5} />}
                  </div>
                ...
                <div className="p-6 text-center bg-gray-100 rounded-lg md:p-8">
                  <div className="mb-2 text-4xl font-bold text-gray-800 md:text-5xl">
                    {counterState && <CountUp start={0} end={44301} duration={5} />}
                  </div>
